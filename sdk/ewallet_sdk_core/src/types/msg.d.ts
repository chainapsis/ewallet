...
export type EWalletMsg = EWalletMsgInit | EWalletMsgInitAck | EWalletMsgGetPublicKey | EWalletMsgGetPublicKeyAck | EWalletMsgSetOAuthNonce | EWalletMsgSetOAuthNonceAck | EWalletMsgOAuthSignIn | EWalletMsgOAuthSignInAck | EWalletMsgSignOut | EWalletMsgSignOutAck | EWalletMsgMakeSignature | EWalletMsgMakeSignatureAck | EWalletMsgShowModal | EWalletMsgShowModalAck | EWalletMsgHideModal | EWalletMsgHideModalAck | EWalletMsgGetEmail | EWalletMsgGetEmailAck | EWalletMsgInitState | EWalletMsgInitStateAck | {
    target: "keplr_ewallet_sdk";
